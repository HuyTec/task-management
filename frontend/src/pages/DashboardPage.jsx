    ...
    <main className="dashboard-shell">
      ...
      <section className="dashboard-content">
        ...
        <div className="dashboard-grid">
          <Link className="metric-card metric-card--link" to="/projects"><span>Planning</span><strong>Project portfolio</strong><p>Group related outcomes inside a clear delivery window.</p></Link>
